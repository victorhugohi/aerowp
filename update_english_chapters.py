...
base_dir = "d:\\hello\\aerowp\\en"

new_nav_items = """                <li><a href="index.html">Home</a></li>
...
chapter_links = "\n".join([f'                <li><a href="chapter{i}.html">Chapter {i}</a></li>' for i in range(1, 15)])

new_bottom_nav = """                <li><a href="#">Glossary</a></li>
                <li>
                    <hr style="border-color: rgba(255,255,255,0.1);">
                </li>
